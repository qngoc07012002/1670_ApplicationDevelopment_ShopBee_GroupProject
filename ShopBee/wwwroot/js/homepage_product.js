const dataUrl = '/Customer/Home/GetAllBook'; 
            ...
            <a class="home-product-item-link" href="#">
                ...
                <div class="home-product-item__info">
                    ...
                    <div class="home-product-item__price">
                        <p class="home-product-item__price-old">${item.actualPrice}đ</p>
                        <p class="home-product-item__price-new">${item.discountPrice}đ</p>
                ...
                <div class="home-product-item-footer">Xem Thông Tin Chi Tiết</div>
            </a>
        </div>`;
    })
